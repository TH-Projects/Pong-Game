...
/*
 * DSchndr was here.
 * Code needs more comments so i write one here.
 * 
 * If you fail to optimize this algorithm, add one to the counter below:
 * 
 * total_hours_wasted_here = 723;
 * 
 * 
 * */
...
namespace Pong
{
	...
	{
		const int movementSpeed1 = 5;
		const int movementSpeed2 = 5;
		int movementspeedBall = 7;
		int movementspeedBall2 = 7;
		...
		private void timer_Tick(object sender, EventArgs e)
		{
			...
			if (Ball1.Location.X + Ball1.Width > Game.Bounds.Width)
			{
				Score1++;
				Ball1.Location = new Point(Game.Bounds.Width / 2, Game.Bounds.Height / 2);
			}
